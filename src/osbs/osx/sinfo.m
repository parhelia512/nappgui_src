...
{
#if defined(MAC_OS_VERSION_27_0) && MAC_OS_X_VERSION_MIN_REQUIRED >= MAC_OS_VERSION_27_0
    return ekMACOS_GOLDEN_GATE;
#elif defined(MAC_OS_VERSION_26_0) && MAC_OS_X_VERSION_MIN_REQUIRED >= MAC_OS_VERSION_26_0
